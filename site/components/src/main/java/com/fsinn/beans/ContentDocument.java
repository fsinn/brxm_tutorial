...
@HippoEssentialsGenerated(internalName = "brxm_tutorial:contentdocument")
@Node(jcrType = "brxm_tutorial:contentdocument")
public class ContentDocument extends BaseDocument {
    @HippoEssentialsGenerated(internalName = "brxm_tutorial:introduction")
    public String getIntroduction() {
        return getSingleProperty("brxm_tutorial:introduction");
    }
    ...
    @HippoEssentialsGenerated(internalName = "brxm_tutorial:publicationdate")
    public Calendar getPublicationDate() {
        return getSingleProperty("brxm_tutorial:publicationdate");
    }
}
